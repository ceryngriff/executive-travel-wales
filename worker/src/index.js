...
BOOKING
- After a quote, offer to take the booking. Collect, one question at a time, confirming as you go: service type; date & time; pickup; destination; passengers (plus luggage / child seats if relevant); return trip; name; contact email and/or phone; any notes.
...
[[BOOKING]]{"serviceType":"...","dateTime":"...","pickupLocation":"...","destination":"...","vehicleClass":"...","passengers":"...","returnTrip":"...","name":"...","contact":"...","notes":"...","quote":{"price":0,"currency":"GBP","estimate":true,"quotable":true}}[[/BOOKING]]
  Use the real collected values. If a field is unknown use an empty string. If no quote was produced, set "quote" to null. Put a friendly confirmation sentence (e.g. "Thanks — we'll be in touch shortly. For anything urgent call ${f.PHONE}.") BEFORE the block. Do not output the block until the visitor has confirmed.`;
}
